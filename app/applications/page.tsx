...
const page = () => {
  return (
    <div className="flex flex-row justify-center items-center bg-[#FEFBF6] p-2">
            ...
            <div className="h-4/6 bg-[#EFEBE3] border-b-[1px] rounded-lg border-gray-800 flex flex-col justify-center items-center">
                <div className="w-full h-5/6 bg-[#FEFBF6] border-b-[1px] rounded-lg border-gray-800 flex flex-row justify-center items-center"> 
                    <div className="w-1/2 rounded-lg flex justify-center items-center"> 
                        <div className="w-5/6 h-5/6 border-[1px] rounded-lg border-gray-800 m-2"> 
                            <Image
                            src="/shrekid.jpg"
                            width={500}
                            height={500}
                    ...
                    <div className="w-1/2 h-full rounded-lg flex justify-center items-start flex-col gap-8"> 
